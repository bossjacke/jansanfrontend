      ...
      <div className="footerInner">
        ...
        <div className="footerMain">
          ...
          <div className="footerBrand">
            <div className="footerLogoRow">
              <div className="footerLogoBox">
                <img src={img} alt="Adams Fire" className="footerLogoImg" />
              </div>
              <h3 className="footerBrandName">Adams Fire</h3>
            </div>
          ...
          <div className="footerLinks">
            <h4 className="footerLinksTitle">Quick Links</h4>
          ...
          <div className="footerContact">
            <h4 className="footerLinksTitle">Connect</h4>
            <div className="footerContactContent">
              <p className="footerContactMail">
              ...
              <div className="footerSocialRow">
                <button
                  ...
                  aria-label="Facebook"
                >
                  <svg className="footerIcon" fill="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <svg className="footerIcon" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 
                    6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 
                    1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 
                    4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 
                    4.936 4.936 0 004.604 3.417 9.867 9.867 0 
